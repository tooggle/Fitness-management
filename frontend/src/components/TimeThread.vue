...
const buttonText=ref(['完成计划','完成计划','完成计划','完成计划','完成计划','完成计划','完成计划',
  ...
  '完成计划','完成计划','完成计划','完成计划','完成计划','完成计划','完成计划',
  '完成计划','完成计划','完成计划','完成计划','完成计划','完成计划','完成计划',])
const DoneDates=ref(['2025-05-01','2025-05-02','2025-05-03','2025-05-04','2025-05-05','2025-05-06','2025-05-07',
...
// 设置特定的开始日期，比如 2025年9月1日
const startDate = ref(dayjs('2025-05-01').toDate());
// 设置结束日期为28天后的日期
